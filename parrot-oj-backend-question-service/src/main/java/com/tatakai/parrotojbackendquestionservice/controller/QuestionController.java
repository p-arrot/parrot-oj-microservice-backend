package com.tatakai.parrotojbackendquestionservice.controller;
...
import com.tatakai.parrotojbackendcommon.common.DeleteRequest;
...
import com.tatakai.parrotojbackendmodel.dto.question.*;
...
public class QuestionController {
    ...
    public BaseResponse<QuestionVO> getQuestionVOById(long id, HttpServletRequest request) {
        ...
        if (JdHotKeyStore.isHotKey(key)) {
            Object questionObject = JdHotKeyStore.get(key);
            if (questionObject != null) {
                return ResultUtil.success((QuestionVO) questionObject);
            }
        }
...
//        Page<Question> questionPage = questionService.page(new Page<>(current, size),
//                questionService.getQueryWrapper(questionQueryRequest));
        Page<Question> questionPage = questionService.searchQuestionFromES(questionQueryRequest);
...
//                questionService.getQueryWrapper(questionQueryRequest));
    ...
    @PostMapping("/search")
    public BaseResponse<Page<QuestionVO>> searchQuestion(@RequestBody QuestionQueryRequest questionQueryRequest, HttpServletRequest request) {
        Page<Question> questionPage = questionService.searchQuestionFromES(questionQueryRequest);
        return ResultUtil.success(questionService.getQuestionVOPage(questionPage, request));
    }
