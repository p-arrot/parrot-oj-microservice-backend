 ...
 * 用户服务
 */
@FeignClient(name = "parrot-oj-backend-user-service", path = "/api/user/inner")
public interface UserFeignClient {
    /**
     * 用户登录态键
     */
    String USER_LOGIN_STATE = "login_user";
    ...
    default boolean isAdmin(User user) {
        return user != null && AuthEnum.ADMIN.getValue().equals(user.getUserRole());
    }
